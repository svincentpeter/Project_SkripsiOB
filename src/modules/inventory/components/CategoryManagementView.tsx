    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-bold text-slate-900">Master Kategori Produk</h2>
            <p className="text-xs text-slate-500">
              Kelola pengelompokan produk, klasifikasi suku cadang, dan kode kategori katalog.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-xs sm:text-sm focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
                  ...
                  <td colSpan={7} className="py-12 text-center text-slate-500">
                    <div className="max-w-sm mx-auto space-y-2">
                      ...
                      <p className="text-xs text-slate-400">
                        {searchQuery ? 'Coba ubah kata kunci pencarian Anda.' : 'Klik tombol "+ Tambah Kategori" untuk membuat kategori baru.'}
                      </p>
                    </div>
                  </td>
                </tr>
